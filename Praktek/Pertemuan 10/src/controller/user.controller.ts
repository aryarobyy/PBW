...
export const updateUser = async (
  ...
  try {
    ...
    successRes(res, 200, updatedUser, "User updated successfully");
  } catch (e: any) {
...
export const deleteUser = async (
  ...
  try {
    ...
    if (!existingUser) {
      errorRes(res, 404, "User tidak ditemukan");
      return;
    }
    ...
    successRes(res, 200, null, "User berhasil dihapus");
  } catch (e: any) {
    console.error("Error in deleteUser:", e);
    errorRes(res, 500, "Gagal menghapus user", e.message);
  }
};
